...
namespace GamerSky.Cache
{
    ...
    public class InMemoryStorage<T>
    {
        ...
        private System.Collections.Generic.SortedDictionary<object, InMemoryStorageItem<T>> _inMemoryStorage = new SortedDictionary<object, InMemoryStorageItem<T>>(); 
        /// <summary>
