...
{
    public class ShadowContentControl : ContentControl
    {
        ...
        public static readonly DependencyProperty Z_DepthProperty =
            DependencyProperty.Register("Z_Depth", typeof(int), typeof(ShadowContentControl), new PropertyMetadata(2));
        ...
        public static readonly DependencyProperty CornerRadiusProperty =
            DependencyProperty.Register("CornerRadius", typeof(double), typeof(ShadowContentControl), new PropertyMetadata(0d));

        public bool IsCached { get; set; }


        public ShadowContentControl()
        {
            this.DefaultStyleKey = typeof(ShadowContentControl);
